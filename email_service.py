...
def send_verification_email(to_email: str, nombre: str, code: str):
    ...
    <body>
        <div class="container">
            ...
            <h3 style="color: #f9dc5e;">Opción 1: Verificación automática</h3>
            <p>Haz clic en el siguiente botón para verificar automáticamente:</p>
            <div style="text-align: center;">
                <a href="{verification_link}" class="button">✓ Verificar mi email ahora</a>
            </div>
            
            <div class="option-divider">O</div>
            
            <h3 style="color: #f9dc5e;">Opción 2: Código manual</h3>
            ...
            <div class="footer">
                ...
                <p style="margin-top: 15px; color: #666;">
                    ...
                    <span style="color: #888; font-size: 11px; word-break: break-all;">{verification_link}</span>
                </p>
            </div>
        </div>
    </body>
